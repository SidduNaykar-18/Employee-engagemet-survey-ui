...
const RecognitionSupport = ({ onValidate, questionData }) => {
  ...
  const handleRadioChange = (questionId, value, options, radioindex) => {
    ...
    dispatch(
      updateSurveyData({
        ...
        dataKey: `radioResponse${radioindex}`, 
        dataValue: payload,
      })
    );
  };
  ...
  useEffect(() => {
    ...
    const isValid =
      recognitionData?.radioResponse1 &&
      recognitionData?.radioResponse2 &&
    ...
    <div style={{ scrollBehavior: "smooth" }}>
      ...
      <div style={{ marginTop: "10px" }}>
        <CustomRadioSelectionCard
          ...
          initialValue={recognitionData?.radioResponse1?.inputValue || ""}
      ...
      <div style={{ marginTop: "10px" }}>
        <CustomRadioSelectionCard
          ...
          initialValue={recognitionData?.radioResponse2?.inputValue || ""}
